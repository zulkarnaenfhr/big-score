        ...
        return (
            <div id="BigScoreAboutUs-Section2">
                <div className="BigScoreAboutUs-Section2-Content-Container">
                    <img src={require("../../../src/Big-Score/AboutUs/Section2-Vector.png")} alt="" className="BigScoreAboutUs-Section2-Vector" data-aos="fade-up-right" data-aos-offset="0" data-aos-delay="200" />
                    <div className="BigScoreAboutUs-Section2-Title-Container">
                        <h1 className="BigScoreAboutUs-Section2-Title1" data-aos="fade-left" data-aos-offset="0">
                            Our ‎ Mission
                        </h1>
                        <h1 className="BigScoreAboutUs-Section2-Title2" data-aos="fade-left" data-aos-offset="0">
                            Purpose Value
                        </h1>
                    </div>
                    <p className="BigScoreAboutUs-Section2-Text" data-aos="fade-up" data-aos-offset="0">
                    ...
                    <div className="BigScoreAboutUs-Section2-List-Container">
                        ...
                        <div className="row BigScoreAboutUs-Section2-List-Row2" data-aos="fade-up" data-aos-offset="0">
                            <div className="col-1">
                                <img src={require("../../../src/Big-Score/Big-Score-Checklist.png")} className="BigScoreAboutUs-Section2-Checklist" alt="" />
                            </div>
                            <div className="col-11">
